...
randomNumber = Math.floor((Math.random()*quick_draw_data_set)+1);
sketch = quick_draw_data_set[randomNumber];
console.log(elementOfQuickDrawDataSet);
document.getElementById("whatToDraw").innerHTML = "What You Have To Draw: " + sketch;
timerCounter = 0;
timerCheck = "";
drawnSketch = "";
answer = "";
...
function checkSketch() {
    ...
    if(timerCheck == "complete"||answer == "correct") {
            timerCheck = "";
            answer = "";
            clearCanvas();
    }
